...
const AboutUs = () => {
  ...
  return (
    <section ref={ref} className="py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 dark:text-white overflow-hidden">
            ...
            <div className="max-w-xl">
              ...
              >
                ...
                <p className="text-lg text-gray-700 dark:text-gray-200 mb-8 leading-relaxed">
                  SeniorLink is the first marketplace in Poland focused entirely on
                  services and institutions supporting senior citizens. We bring
                  together care homes, caregivers, nurses, senior product stores,
                  medical transport, and social institutions — all in one platform.
                </p>
              </motion.div>
                    ...
                    <div key={colIndex}>
                      {column.map((service, index) => (
                        <motion.div 
                          ...
                          transition={{ delay: 0.3 + (index * 0.1) + (colIndex * 0.3) }}
