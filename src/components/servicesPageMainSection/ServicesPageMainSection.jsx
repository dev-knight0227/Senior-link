      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/search-care" className="inline-flex items-center px-6 py-3 border border-[#206645] text-[#206645] hover:bg-[#206645]/5 font-medium rounded-lg transition-colors duration-300">
              Find Services
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <motion.div variants={fadeIn} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-6">
                <Link href="/search-care" className="inline-flex items-center px-5 py-2.5 bg-[#206645] hover:bg-[#185536] text-white font-medium rounded-lg transition-colors duration-300">
                  Find care services
        ...
        >
          <div className="bg-[#206645] dark:bg-[#206645]/80 rounded-2xl overflow-hidden shadow-xl p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/search-care" className="inline-flex items-center justify-center px-6 py-3 border-2 border-white text-white font-medium rounded-lg hover:bg-white/10 transition-colors duration-300">
                Search for care
              </Link>
            </div>
          </div>
