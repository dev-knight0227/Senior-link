              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-[#206645] dark:text-[#3b9ede] font-medium mt-1">(555) 123-4567</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-[#206645] dark:text-[#3b9ede] font-medium mt-1">care@seniorlink.com</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div className="p-4">
                <div className="bg-white dark:bg-gray-700 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#206645] dark:text-[#3b9ede]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
